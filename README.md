...
**Note**: This application is designed for educational purposes and development environments. For production use, implement proper database storage, authentication, and security measures.
